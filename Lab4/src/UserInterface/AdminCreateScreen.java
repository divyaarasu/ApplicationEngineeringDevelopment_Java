   ...
   private boolean passwordPatternCorrect() {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (!passwordPatternCorrect()) {
            txtPword.setBorder(new LineBorder(Color.RED));
            jLabel2.setForeground(Color.RED);
            JOptionPane.showMessageDialog(null, "Password should have been in a format Aa1@aa");
            return;
        }
        ...
        if (!radioCustomer.isSelected() && !radioSupplier.isSelected()) {
            JOptionPane.showMessageDialog(null, "Please select whether you are a Customer or Supplier");
            return;
        }
